...
public class Pokemon {
    ...
    public Pokemon(String name, Integer attack, Integer defense, String height, Integer health, Integer pokedexId, Integer speed,
                   String weight, List<Sprite> sprites, List<PokeType> pokeTypes) {
        this.name = name;
        this.attack = attack;
